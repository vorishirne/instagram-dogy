...
class FlutterLogin extends StatefulWidget {
  ...
  final Future<void> Function() gLogin;
  final Future<void> Function() fLogin;
  final Future<void> Function() tLogin;
...
class _FlutterLoginState extends State<FlutterLogin>
  ...
  Widget serviceAgreement = Column(children: [
    RichText(
      text: new TextSpan(
        children: [
          new TextSpan(
            text: 'By continuing you comply with our',
            style: new TextStyle(
    ...
    RichText(
      text: new TextSpan(
        children: [
          new TextSpan(
            text: 'license terms and agreement',
            style: new TextStyle(
                color: Color.fromRGBO(127, 127, 127, 1),
  ...
  Widget build(BuildContext context) {
    ...
    final cardTopPosition = deviceSize.height / 2 - cardInitialHeight / 2 + 30;
      ...
      providers: [
        ...
        ChangeNotifierProvider(
          create: (context) => Auth(
            ...
            fLogin: widget.fLogin,
            gLogin: widget.gLogin,
            tLogin: widget.tLogin,
